...
#kakk1は１２を切った時２は２３を切った時３は３１を切った時0はドコモ切らなかったときのグラフ
...
plt.plot(t, kekka11, color = "blue", label = "N1 max={}".format(max(kekka11)), linewidth = 1.0)
plt.plot(t, kekka12, color = "red", label = "N2 max={}".format(max(kekka12)), linewidth = 1.0)
plt.plot(t, kekka13, color = "green", label = "N3 max={}".format(max(kekka13)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c12を切った時の時間変化')  # グラフタイトル パラメータmとTの値表示
...
plt.plot(t, sumkekka11, color = "blue", label = "N1 sum={}".format(sumkekka11[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka12, color = "red", label = "N2 sum={}".format(sumkekka12[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka13, color = "green", label = "N3 sum={}".format(sumkekka13[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c12を切ったときの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, kekka21, color = "blue", label = "N1 max={}".format(max(kekka21)), linewidth = 1.0)
plt.plot(t, kekka22, color = "red", label = "N2 max={}".format(max(kekka22)), linewidth = 1.0)
plt.plot(t, kekka23, color = "green", label = "N3 max={}".format(max(kekka23)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c23を切った時の時間変化')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka21, color = "blue", label = "N1 sum={}".format(sumkekka21[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka22, color = "red", label = "N2 sum={}".format(sumkekka22[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka23, color = "green", label = "N3 sum={}".format(sumkekka23[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c23を切ったときの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, kekka31, color = "blue", label = "N1 max={}".format(max(kekka31)), linewidth = 1.0)
plt.plot(t, kekka32, color = "red", label = "N2 max={}".format(max(kekka32)), linewidth = 1.0)
plt.plot(t, kekka33, color = "green", label = "N3 max={}".format(max(kekka33)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c31を切った時の時間変化')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka31, color = "blue", label = "N1 sum={}".format(sumkekka31[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka32, color = "red", label = "N2 sum={}".format(sumkekka32[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka33, color = "green", label = "N3 sum={}".format(sumkekka33[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('c31を切ったときの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, kekka11, color = "blue", label = "c12切 max={}".format(max(kekka11)), linewidth = 1.0)
plt.plot(t, kekka21, color = "red", label = " c23切max={}".format(max(kekka21)), linewidth = 1.0)
plt.plot(t, kekka31, color = "green", label = " c31切max={}".format(max(kekka31)), linewidth = 1.0)
plt.plot(t, kekka01, color = "black", label = "切断無 max={}".format(max(kekka01)), linewidth = 1.0)
#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('人口が一番多い街のそれぞれの時間変化')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka11, color = "blue", label = "c12切sum={}".format(sumkekka11[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka21, color = "red", label = "c23切sum={}".format(sumkekka21[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka31, color = "green", label = "c31切sum={}".format(sumkekka31[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka01, color = "black", label = "切断無sum={}".format(sumkekka01[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('人口が一番多い所のそれぞれの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, kekka13, color = "blue", label = "c12切 max={}".format(max(kekka13)), linewidth = 1.0)
plt.plot(t, kekka23, color = "red", label = "c23切 max={}".format(max(kekka23)), linewidth = 1.0)
plt.plot(t, kekka33, color = "green", label = "c31切 max={}".format(max(kekka33)), linewidth = 1.0)
plt.plot(t, kekka03, color = "black", label = "切断無 max={}".format(max(kekka03)), linewidth = 1.0)
#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('人口が一番少ない街のそれぞれの時間変化')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka13, color = "blue", label = "c12切sum={}".format(sumkekka13[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka23, color = "red", label = "c23切sum={}".format(sumkekka23[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka33, color = "green", label = "c31切sum={}".format(sumkekka33[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka03, color = "black", label = "切断無sum={}".format(sumkekka03[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('人口が一番少ない所のそれぞれの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, kekka12, color = "blue", label = "c12切 max={}".format(max(kekka12)), linewidth = 1.0)
plt.plot(t, kekka22, color = "red", label = "c23切 max={}".format(max(kekka22)), linewidth = 1.0)
plt.plot(t, kekka32, color = "green", label = "c31切 max={}".format(max(kekka32)), linewidth = 1.0)
plt.plot(t, kekka02, color = "black", label = "切断無 max={}".format(max(kekka02)), linewidth = 1.0)
#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('N2のそれぞれの時間変化')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka12, color = "blue", label = "c12切sum={}".format(sumkekka12[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka22, color = "red", label = "c23切sum={}".format(sumkekka22[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka32, color = "green", label = "c31切sum={}".format(sumkekka32[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka02, color = "black", label = "切断無sum={}".format(sumkekka02[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('N2所のそれぞれの累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N+0.1,N/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
