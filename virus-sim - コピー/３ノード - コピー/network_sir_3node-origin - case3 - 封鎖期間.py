...
plt.plot(lima, (peak[0]-peak)/lima, color = "blue", label = "sum={}".format(sum1[n-1]), linewidth = 1.0)
...
plt.plot(lima, (sumkekka[0]-sumkekka)/lima, color = "red", label = "sum={}".format(sum2[n-1]), linewidth = 1.0)
