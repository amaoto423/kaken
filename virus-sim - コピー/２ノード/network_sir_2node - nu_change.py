...
nu=np.arange(0,0.01,0.0001)
kekka1=np.empty(100)

sumkekka1=np.empty(100)
# （3）SIRモデル
# 3-1パラメータ
N1 = 6000000             # 街１の人口
N2 = 4000000               #街２の人口
...
plt.plot(nu, sumkekka1, color = "blue",  linewidth = 1.0)
...
plt.xlabel('小さい方の街のワクチン接種率')                              # 横軸ラベル
plt.ylabel('各町の重症者の和')      # 縦軸ラベル
