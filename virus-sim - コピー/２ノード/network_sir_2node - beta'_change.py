...
plt.plot(t, sum1, color = "blue", label = "beta=2.0*10^-8 sum={}".format(sum1[n-1]), linewidth = 1.0)
plt.plot(t, sum2, color = "red", label = "beta=4.0*10^-8 sum={}".format(sum2[n-1]), linewidth = 1.0)
plt.plot(t, sum1+sum2, color = "green", label = "beta=6.0*10^-8 sum={}".format(sum1[n-1]+sum2[n-1]), linewidth = 1.0)
