...
plt.plot(t, Is1, color = "blue", label = "alpha=0.01 max={}".format(max(Is1)), linewidth = 1.0)
plt.plot(t, Is2, color = "red", label = "alpha=0.02 max={}".format(max(Is2)), linewidth = 1.0)
plt.plot(t, Is3, color = "green", label = "alpha=0.01 max={}".format(max(Is3)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('αを変えた場合のシミュレーション')  # グラフタイトル パラメータmとTの値表示
...
plt.plot(t, sum1, color = "blue", label = "alpha=0.01 sum={}".format(sum1[n-1]), linewidth = 1.0)
plt.plot(t, sum2, color = "red", label = "alpha=0.02 sum={}".format(sum2[n-1]), linewidth = 1.0)
plt.plot(t, sum3, color = "green", label = "alpha=0.1 sum={}".format(sum3[n-1]), linewidth = 1.0)
