...
a=0.0000002
plt.plot(t, kekka11, color = "blue", label = "beta={:.3g} max={}".format((beta1+beta2)/10,max(kekka11)), linewidth = 1.0)
plt.plot(t, kekka21, color = "red", label = "beta={:.3g} max={}".format(2*(beta1+beta2)/10,max(kekka21)), linewidth = 1.0)
plt.plot(t, kekka31, color = "green", label = "beta={:.3g} max={}".format(3*(beta1+beta2)/10,max(kekka31)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('感染が始まった街の感染者の時間変化')  # グラフタイトル パラメータmとTの値表示
...
plt.plot(t, kekka12, color = "blue", label = "beta={:.3g} max={}".format((beta1+beta2)/10,max(kekka12)), linewidth = 1.0)
plt.plot(t, kekka22, color = "red", label = "beta={:.3g} max={}".format(2*(beta1+beta2)/10,max(kekka22)), linewidth = 1.0)
plt.plot(t, kekka32, color = "green", label = "beta={:.3g} max={}".format(3*(beta1+beta2)/10,max(kekka32)), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('感染が始まっていない方の街の時間変化')  # グラフタイトル パラメータmとTの値表示
...
plt.plot(t, sumkekka11, color = "blue", label = "sum={}".format(sumkekka11[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka21, color = "red", label = "sum={}".format(sumkekka21[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka31, color = "green", label = "sum={}".format(sumkekka31[n-1]+sum2[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('感染が始まった街の累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N1+N2+0.1,(N1+N2)/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N1+N2)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
...
plt.plot(t, sumkekka12, color = "blue", label = "sum={}".format(sumkekka12[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka22, color = "red", label = "sum={}".format(sumkekka22[n-1]), linewidth = 1.0)
plt.plot(t, sumkekka32, color = "green", label = "sum={}".format(sumkekka32[n-1]), linewidth = 1.0)

#plt.plot(t, R1, color= "blue", label = "R:免疫獲得者", linewidth = 1.0)
# グラフの見た目設定
plt.title('感染が始まっていない街の累積')  # グラフタイトル パラメータmとTの値表示
#plt.yticks(np.arange(0,N1+N2+0.1,(N1+N2)/10))    # y軸 目盛りの配分 0からN（=1000万）までを10等分 N/10（=100万）刻み Nを含めるためNをN+0.1としておく
#plt.gca().set_yticklabels(['{:.0f}%'.format(y/((N1+N2)/100)) for y in plt.gca().get_yticks()])   # y軸目盛りを％表示に変更
plt.xlabel('時間（日）')                              # 横軸ラベル
plt.ylabel('人数')      # 縦軸ラベル
